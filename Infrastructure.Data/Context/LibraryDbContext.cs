    ...
    public class LibraryDbContext : DbContext
    {
        ...
        public override int SaveChanges()
        {
            ...
            foreach (var entityEntry in entries)
            {
                ...
                ((AuditableBaseEntity)entityEntry.Entity).UpdatedOn = DateTime.UtcNow;
                ((AuditableBaseEntity)entityEntry.Entity).UpdatedBy = this._httpContextAccessor?.HttpContext?.User?.Identity?.Name ?? "MyApp";
            }
